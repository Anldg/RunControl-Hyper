...
{   
    ...
    public void CikisButonislem(string durum)
    {
        ...
        var ayar = GameObject.Find("Ayar");
        var ayarButonu = ayar.GetComponent<Button>();
        ayarButonu.interactable = false;
    ...
    public void Ayarlar(string durum)
    {
        if (durum == "ayarla")
        {
            ...
            Time.timeScale = 0;
            var cikis = GameObject.Find("Cikis");
            cikis.GetComponent<Button>().interactable = false;
        }
        else
        {
            ...
            Time.timeScale = 1;
            var cikis = GameObject.Find("Cikis");
            cikis.GetComponent<Button>().interactable = true;
        }
    }
