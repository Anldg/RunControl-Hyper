...
public class Ozellestirme : MonoBehaviour
{
    ...
    public void SapkaYon_Butonlari(string islem)
    {
        ...
        if (islem == "ileri")
        {
            ...
            SapkaButonAktivasyonunuDegistir();
        }
        else
        {
            if(SapkaIndex != -1)
    ...
    public void Sopa_YonButonlari(string islem)
    {
        ...
        if (islem == "ileri")
        {
            ...
            SopaButonAktivasyonunuDegistir();
        }
        else
        {
            if (SopaIndex != -1)
    ...
    public void Material_YonButonlari(string islem)
    {
        ...
        if (islem == "ileri")
        {
            ...
            MateryalButonAktivasyonunuDegistir();
        }
        else
        {
            if (MaterialIndex != -1)
    ...
    private void MateryalButonAktivasyonunuDegistir()
    {
    ...
    private void SapkaButonAktivasyonunuDegistir()
    {
    ...
    private void SopaButonAktivasyonunuDegistir()
    {
